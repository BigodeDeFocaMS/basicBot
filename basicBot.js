...
$.get("https://rawgit.com/italocjs/basicBot/master/lang/langIndex.json", function (json) {
...
var botCreator = "Matthew aka. italocjs";
var botCreatorIDs = [];
var basicBot = {
version: "6.6.6",
status: false,
name: "basicBot",
loggedInID: null,
scriptLink: "https://rawgit.com/italocjs/basicBot/master/basicBot.js",
...
lockskipPosition: 3,
lockskipReasons: [
["tema", "Essa musica esta no genero proibido, vou te pulei. "],
["op", "Para de repetir essa merda, vou te pulei, animal. "],
["history", "TA NO HISTORICO JUMENTO, vou te pulei"],
...
motdEnabled: true,
motdInterval: 5,
motd: "Bem vindo seus tesudos, leiam as regras e entrem no nosso grupo",
filterChat: true,
etaRestriction: false,
welcome: true,
opLink: null,
rulesLink: "http://bit.ly/1rS39NK",
themeLink: null,
fbLink: "http://tinyurl.com/nrjujoc",
youtubeLink: null,
website: null,
intervalMessages: [],
messageInterval: 5,
...
rank: 'user',
type: 'startsWith',
cookies: ['Te puniu com 5 dias sem sexo!',
'Te puniu com um boquete da dilma',
'Contratou uma batata assasina para te matar',
'Enfiou o dedo no seu cu.',
'Te fez um blowjob com uma pinça',
'Mandou você ir morar no nordeste',
'Diminuiu seu penis para 4',
'Deixou seu bumbum assado"',
],
getCookie: function () {
